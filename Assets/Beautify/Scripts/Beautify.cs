...
namespace BeautifyEffect {
    ...
    public partial class Beautify : MonoBehaviour {
        ...
        public bool compareSameSide {
            get { return _compareSameSide; }
            set {
                if (_compareSameSide != value) {
                    _compareSameSide = value;
                    UpdateMaterialProperties();
                }
            }
        }
        ...
        const string BEAUTIFY_BUILD_HINT = "BeautifyBuildHint103b1";
        ...
        public void UpdateMaterialPropertiesNow() {
            ...
            if (_compareMode) {
                renderPass = 0;
                float angle = _compareSameSide ? Mathf.PI * 0.5f : _compareLineAngle;
                bMat.SetVector(ShaderParams.CompareData, new Vector4(Mathf.Cos(angle), Mathf.Sin(angle), _compareSameSide ? _comparePanning : -10, _compareLineWidth));
            }
